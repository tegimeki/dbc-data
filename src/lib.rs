...
//! subset of the messages and signals defined in the `.dbc` file
//! are of interest, and the rest can be ignored.
//!
//! ## Messages
...
//! * Encode signal into PDU (__byte-aligned only in this version__)
//!
//! # TODO
//! * Encode all signals into PDU (some combinations work, but not all)
